	   ...
	   $_SERVER["REQUEST_METHOD"] == "GET"){
		...
		=============================================*/
			...
			if( explode("?", $routesArray[1])[0] == "relations" && isset($_GET["rel"]) && isset($_GET["type"])){
				...
				$response = new GetController();
				$response -> getSearchRelData($_GET["rel"], $_GET["type"], $_GET["linkTo"], $_GET["search"], $orderBy, $orderMode, $startAt, $endAt, $select);

			}else{

				$response = new GetController();
				$response -> getSearchData(explode("?", $routesArray[1])[0], $_GET["linkTo"], $_GET["search"], $orderBy, $orderMode, $startAt, $endAt, $select);
		...
		=============================================*/
			...
			if( explode("?", $routesArray[1])[0] == "relations" && isset($_GET["rel"]) && isset($_GET["type"])){
				...
				$response = new GetController();
				$response -> getBetweenRelData($_GET["rel"], $_GET["type"], $_GET["linkTo"], $_GET["between1"], $_GET["between2"], $_GET["filterTo"], $_GET["inTo"], $orderBy, $orderMode, $startAt, $endAt, $select);

			}else{

				$response = new GetController();
				$response -> getBetweenData(explode("?", $routesArray[1])[0], $_GET["linkTo"], $_GET["between1"], $_GET["between2"], $_GET["filterTo"], $_GET["inTo"], $orderBy, $orderMode, $startAt, $endAt, $select);
		...
		=============================================*/
			...
			$response = new GetController();
			$response -> getData(explode("?", $routesArray[1])[0], $orderBy, $orderMode, $startAt, $endAt, $select);
